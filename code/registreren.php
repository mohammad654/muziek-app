...
<div class="container text-center center">
    ...
    <form method="POST">
        <div class="form-group ">
            ...
            <input type="email" class="form-control border-primary mb-3 mt-1 p-4 " name="email" id="exampleInputEmail1"
                   aria-describedby="emailHelp" placeholder="" required>


            <label for="exampleInputPassword1">Wachtwoord</label>
            <input type="password" class="form-control border-primary mb-3 mt-1 p-4" id="exampleInputPassword1" name="password"
                   required>

            <label for="exampleInputPassword1"> Bevestig Wachtwoord</label>
            <input type="password" class="form-control border-primary mb-3 mt-1 p-4" id="exampleInputPassword1" name="confirm_password"
                   required>
